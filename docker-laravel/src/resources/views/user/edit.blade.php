...
<div class="container">
    ...
    <form action="{{ url('user/'.$user->id) }}" method="post">
        ...
        <div class="form-group">
            ...
            @if ($errors->has('bio')) is-invalid @endif"
            name="bio" rows="8" autofocus>{{ old('bio', $user->bio) }}</textarea>
            @if ($errors->has('bio'))
                <span class="invalid-feedback" role="alert">
                    {{ $errors->first('bio') }}
                </span>
            ...
            @if ($errors->has('twitter')) is-invalid @endif"
            name="twitter" value="{{ old('twitter', $user->twitter) }}" autofocus>
            ...
            @if ($errors->has('instagram')) is-invalid @endif"
            name="instagram" value="{{ old('instagram', $user->instagram) }}" autofocus>
            ...
            @if ($errors->has('github')) is-invalid @endif"
            name="github" value="{{ old('github', $user->github) }}" autofocus>
            ...
            @if ($errors->has('facebook')) is-invalid @endif"
            name="facebook" value="{{ old('facebook', $user->facebook) }}" autofocus>
