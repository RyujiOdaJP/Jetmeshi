...
<div class="row form-group justify-content-around">
    <div class="col2">
      ...
      <input id="cooking_time" type="range"  min="0" max="60"
      value="{{ old_value($post, 'cooking_time') }}"
      step="1" class="custom-range" name="cooking_time" rows="8" required>
      </input>
    ...
    <div class="col2">
      ...
      <input id="budget" type="range" min="0" max="2000"
      value="{{ old_value($post, 'budget') }}" step="10" class="custom-range"
      name="budget" rows="8" required>
      </input>
