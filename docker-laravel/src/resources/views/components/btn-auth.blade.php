...
<div class="form-group row ">
    <div class="col-md-10 ml-auto mr-auto">
        <button id={{ $id_attr."-normal-user" }} class="btn btn-block btn-Jetgreen " type="submit" style="padding-box;
...
<div class="form-group row mb-0">
    <div class="col-md-10 ml-auto mr-auto">
        <button id={{ $id_attr."-google-user" }} class="btn btn-block " type="submit" style="border: 2px solid #5CB85C;
      border-radius: 24px; height:40px; opacity: 1;">
